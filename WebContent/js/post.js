...
$(document).ready(function() {
	...
	var $post_example = $('#post_example');//we have the formObject in this variable....
	...
	$('#submit_it').click(function(e) {
		...
		ajaxObj = {  
			type: "POST",
			url: "http://localhost:8080/com.youtube.rest/api/v2/inventory/", 
	...
	$('#submit_it2').click(function(e) {
		...
		ajaxObj = {  
			type: "POST",
			url: "http://localhost:8080/com.youtube.rest/api/v3/inventory/", 
			data: JSON.stringify(jsObj), 
			contentType:"application/json",
			error: function(jqXHR, textStatus, errorThrown) {
				console.log("Error " + jqXHR.getAllResponseHeaders() + " " + errorThrown);
